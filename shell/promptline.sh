...
function __promptline_right_prompt {
  ...
  local y_insert_bg="${wrap}48;5;9${end_wrap}"
  local y_insert_fg="${wrap}38;5;15${end_wrap}"
  local y_insert_sep_bg="${wrap}48;5;15${end_wrap}"
  local y_insert_sep_fg="${wrap}38;5;9${end_wrap}"
  ...
  if [ $vim_mode = $vim_ins_mode ]; then
    ...
    slice_prefix="${y_insert_sep_fg}${rsep}${y_insert_fg}${y_insert_bg}${space}" slice_suffix="$space${y_sep_fg}" slice_joiner="${y_insert_fg}${y_insert_bg}${alt_rsep}${space}" slice_empty_prefix=""
   fi

  #slice_prefix="${y_sep_fg}${rsep}${y_fg}${y_bg}${space}" slice_suffix="$space${y_sep_fg}" slice_joiner="${y_fg}${y_bg}${alt_rsep}${space}" slice_empty_prefix=""
  # section "y" slices
  __promptline_wrapper "$vim_mode" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
